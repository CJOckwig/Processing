...
if(t1.equals("fairy")||t2.equals("fairy")){
  ...
  effectiveness*=2;} else if(move.equals("fighting")||move.equals("bug")||move.equals("dragon")){
  effectiveness*=0;
  }
}
